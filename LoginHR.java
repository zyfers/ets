...
public class LoginHR extends AppCompatActivity {
    ...
    String EmailHolder, PasswordHolder,Designation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  ref.onAuth(function(authData) {
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    Toast.makeText(LoginHR.this, "Reset password mail sent",Toast.LENGTH_LONG).show();
                                    password.setText("");
                                }
                            }
                        });
        ...
        progressDialog =  new ProgressDialog(LoginHR.this);
        ...
        Login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(EditTextEmptyCheck)
                {
                    ...
                    Toast.makeText(LoginHR.this, "Please Fill All the Fields", Toast.LENGTH_LONG).show();
                }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            Intent intent = new Intent(LoginHR.this, Hr.class);
                            ...
                            Toast.makeText(LoginHR.this, "Email or Password Not found, Please Try Again", Toast.LENGTH_LONG).show();
                            //   updateUI(null);
                        }
                    }
