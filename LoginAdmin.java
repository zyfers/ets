                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    Toast.makeText(LoginAdmin.this, "Reset password mail sent",Toast.LENGTH_LONG).show();
                                    password.setText("");
                                }
                            }
                        });
        ...
        Login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(EditTextEmptyCheck)
                {
                    ...
                    Toast.makeText(LoginAdmin.this, "Please Fill All the Fields", Toast.LENGTH_LONG).show();
                }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(LoginAdmin.this, "Email or Password Not found, Please Try Again", Toast.LENGTH_LONG).show();
                            //   updateUI(null);
                        }
                    }
